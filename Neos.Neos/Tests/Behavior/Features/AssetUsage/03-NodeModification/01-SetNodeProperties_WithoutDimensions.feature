...
Feature: Create node aggregate with node without dimensions
  ...
  Scenario: Remove the first of two assets from an assets array in the live workspace
    Given I am in workspace "live"
    And the command SetNodeProperties is executed with payload:
      | Key                       | Value                         |
      | workspaceName             | "live"                        |
  ...
  Scenario: Remove the last of two assets from an assets array in the live workspace
    Given I am in workspace "live"
    And the command SetNodeProperties is executed with payload:
      | Key                       | Value                         |
      | workspaceName             | "live"                        |
  ...
  Scenario: Remove all assets from an assets array in the live workspace
    Given I am in workspace "live"
    And the command SetNodeProperties is executed with payload:
      | Key                       | Value              |
      | workspaceName             | "live"             |
